 ...
 * @author Hakan
 */
public class KullaniciEkrani extends javax.swing.JFrame implements IDuzenleyici{
    ...
    private void kullaniciEkleButonActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        ActionAyarlari.SetVisible(this,new KullanıcıEkleEkrani());
    }                                                  

    private void stokEkleButonActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ActionAyarlari.SetVisible(this, new StokEkleEkrani());
    }                                             

    private void sifreDegistirButonActionPerformed(java.awt.event.ActionEvent evt) {                                                   
    ...
    private void kullaniciBilgiDegistirButonActionPerformed(java.awt.event.ActionEvent evt) {                                                            
        // TODO add your handling code here:
    }                                                           

    private void sifreDegistirButonMouseClicked(java.awt.event.MouseEvent evt) {                                                
        ActionAyarlari.SetVisible(this, new SifreGuncellemeEkrani());
    }                                               

    private void kullaniciBilgiDegistirButonMouseClicked(java.awt.event.MouseEvent evt) {                                                         
